...
export default function DEASPPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="p-2 bg-brand-blue/10 rounded-lg">
            <Anchor className="w-6 h-6 text-[#6060FF]" />
          </div>
          <div>
            <h1 className="text-2xl font-bold text-white">DEASP Italia</h1>
        ...
        <div className="flex items-center space-x-3">
          <button
            ...
            className="relative p-2 text-gray-400 hover:text-brand-yellow rounded-lg hover:bg-surface-hover"
          >
      ...
      {/* Tab Switcher */}
      <div className="flex space-x-1 bg-surface-hover rounded-lg p-1 w-fit">
        <button
          onClick={() => setActiveTab('dashboard')}
          className={`px-4 py-2 text-sm font-medium rounded-md transition-colors ${
            activeTab === 'dashboard' ? 'bg-surface-card text-white shadow-sm' : 'text-gray-400 hover:text-gray-300'
          }`}
        >
          Dashboard DEASP
        </button>
